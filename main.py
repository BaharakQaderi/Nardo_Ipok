...
def on_live_data_available(packet, filename):
    ...
    save_data_to_csv(xbus_data, filename, log_position_velocity=True)


def main():
    try:
        serial = SerialHandler("/dev/ttyAMA0", 115200) ##change the port and baudrate to your own MTi's baudrate.
